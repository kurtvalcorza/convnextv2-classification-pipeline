"""Static release-asset validation for the ConvNeXt V2 Tiny image-classification DIMER pipeline.
...
EXPECTED_MODEL_ID = "facebook/convnextv2-tiny-1k-224"
...
EXPECTED_OUTPUTS = (
    "convnextv2_classification_input_manifest.json",
    "convnextv2_classification_evaluation_report.json",
    "convnextv2_classification_result.json",
    "convnextv2_classification_predictions.csv",
    "convnextv2_adapter.safetensors",
)
